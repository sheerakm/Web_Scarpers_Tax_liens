...
url = r'https://sdttc.mytaxsale.com/auction/45'
    ...
    try:
        ...
        for i in range(0, len(all_trs), 3):
            ...
            if len(summary_tds) >= 7:
                ...
                current_property["Number of Bids"] = summary_tds[2].text.strip()
                current_property["Opening Bid"] = summary_tds[3].text.strip()
                current_property["Best Bid"] = summary_tds[4].text.strip()
