...
Auction_start = datetime(2025, 4, 21, 8, 0, 0, tzinfo=timezone(timedelta(hours=-7)))
Auction_end = datetime(2025, 4, 24, 8, 0, 0, tzinfo=timezone(timedelta(hours=-7)))
...
def push_parcels_from_file(json_file_path):
    ...
    for parcel in parcels:
        ...
        try:
            ...
            lat, lon = convert_location_to_x_y(parcel.get("Address" + county_name, ""))
