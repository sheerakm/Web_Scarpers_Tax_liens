...
#
#
# url = r'https://palmbeach.realtaxdeed.com/index.cfm?zaction=AUCTION&zmethod=PREVIEW&AuctionDate=04/09/2025'
# driver.get(url)
#
# time.sleep(10) # wait = WebDriverWait(driver, 10) agreement page not showing up, so causes problem
#
...
# # exit()
#
# # Find all auction items within the Head_W container
...
#
#     try:
#         next_button = driver.find_element(By.CSS_SELECTOR, ".PageRight")
#         next_button.click()
...
write_parcels_to_firebase(auction_data, key_mapping, 'Florida', 'Palm Beach' )
