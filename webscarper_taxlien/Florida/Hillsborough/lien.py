...
url = r'https://hillsborough.realtaxdeed.com/index.cfm?zaction=AUCTION&Zmethod=PREVIEW&AUCTIONDATE=03/27/2025'
driver.get(url)

time.sleep(10)  # Allow the page to load completely

# Find the Head_W class container
head_w = driver.find_element(By.CLASS_NAME, "Head_C")

# Get total number of pages
total_pages = int(head_w.find_element(By.ID, "maxCA").text.strip())  # Extracts "2" and converts it to int
...
write_parcels_to_firebase(auction_data, key_mapping, 'Florida', 'Hillsborough' )
