...
file_path = "../california/Riverside/RiversideCountyApr25_SaleAuctions_20250429.xlsx"
...
for row in sheet.iter_rows(min_row=4, values_only=True):
    ...
    from miscellaneous.coordinate_checker.offline_checker import is_point_in_state, states, is_point_in_county
  ...
  # fixxxx
    ...
    if x and y :
        if county_ := is_point_in_county(x, y, state_name,  county_name ):
