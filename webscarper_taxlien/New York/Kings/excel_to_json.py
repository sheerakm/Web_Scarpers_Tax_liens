...
county = 'Kings'
state = 'New York'
file_path = r"C:\Users\shira\OneDrive\Desktop\tax_liens_web_scarper\Web_Scarpers_Tax_liens\webscarper_taxlien\New York\Kings\nyctl-2025-60-day-notice-brooklyn (1).xlsx"  # Change this to your actual file path
df = pd.read_excel(file_path)

# Construct the Full Address column
df["Full Address"] = df["House Number"].astype(str) + " " + df["Street Name"] + ' ' + 'Brooklyn' + ", " + 'NY' + ' '+ df["Zip Code"].fillna(0).astype(int).astype(str)
